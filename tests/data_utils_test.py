...
{"data": {"text": "According to the company 's updated strategy for the years 2009-2012 , Basware targets a long-term net sales growth in the range of 20 % -40 % with an operating profit margin of 10 % -20 % of net sales ."}, "predictions": [{"result": [{"value": {"choices": ["Neutral"]}, "from_name": "sentiment", "to_name": "text", "type": "choices"}], "score": 1.0}]}"""
